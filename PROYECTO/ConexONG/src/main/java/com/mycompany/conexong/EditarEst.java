 ...
 * @author Recalde
 */
public class EditarEst extends javax.swing.JFrame {
    ...
    public EditarEst(String codigo,String nombre4,String apellido4,String telefono,String calle,String distrito,String provincia,String dni,int grado,String nivel,int edad4) {
        initComponents();
        ...
        DNIEst.setText(dni);
        NombresEs.setText(nombre4);
        ApellidosEs.setText(apellido4);
        telefest.setText(telefono);
        CalleEst.setText(calle);        
        DsitritoEs.setText(distrito);
        ProvinciaEs.setText(provincia);
        GradoAcEst.setText(Integer.toString(grado));
        NivelAcEst.setText(nivel);
        EdadEst.setText(Integer.toString(edad4));       
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Document nuevosValores = new Document("$set", new Document("dniEst", dni1)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarEst.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
